        ...
        <div class="bg-black/40 fixed top-0 left-0 w-full h-full z-4 flex items-center justify-center">
            <div class="bg-white rounded-md shadow-md shadow-black/70 w-[90%] p-4">
                ...
                <div class="inline-flex items-center">
                    <div
                        class="relative inline-block w-[3.2rem] h-4 -mt-5 rounded-full cursor-pointer border border-[#ddd] border-solid">
                    ...
                    <label for="desc" class="mt-px mb-0 ml-3 font-light text-gray-700 cursor-pointer select-none">
                        <div>
                            <p
                                class="block font-sans text-base antialiased font-medium leading-relaxed text-gray-800 ml-2">
                                Nuevo escaner
                            </p>
                            <p
                                class="block font-sans text-sm antialiased font-normal leading-normal text-gray-700 ml-2">
                ...
                <!-- Mostramos el estado del checkbox -->
